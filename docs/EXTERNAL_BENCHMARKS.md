...
| **3. Internal checks vs external refs** | Re-score perfect-crystal Darwin curve and strained-layer Bragg shift against literature formulas (Authier, kinematic) using *audited* constants | Planned (after Tier 2) |
